#!/bin/bash
# by https://github.com/soeceo/kxj
# 2023.07.17


# curl -L https://raw.githubusercontent.com/soeceo/kxj/main/scripts/lxdinstall.sh -o lxdinstall.sh && chmod +x lxdinstall.sh && bash lxdinstall.sh
...
# 虚拟内存设置
curl -sLk "${cdn_success_url}https://raw.githubusercontent.com/soeceo/kxj/main/scripts/swap2.sh" -o swap2.sh && chmod +x swap2.sh
...
# 下载预制文件
files=(
    "https://raw.githubusercontent.com/soeceo/kxj/main/scripts/ssh.sh"
    "https://raw.githubusercontent.com/soeceo/kxj/main/scripts/alpinessh.sh"
    "https://raw.githubusercontent.com/soeceo/kxj/main/scripts/config.sh"
    "https://raw.githubusercontent.com/soeceo/kxj/main/scripts/buildone.sh"
)
...
if [ ! -f /usr/local/bin/check-dns.sh ]; then
    wget ${cdn_success_url}https://raw.githubusercontent.com/soeceo/kxj/main/scripts/check-dns.sh -O /usr/local/bin/check-dns.sh
    chmod +x /usr/local/bin/check-dns.sh
else
    echo "Script already exists. Skipping installation."
fi
if [ ! -f /etc/systemd/system/check-dns.service ]; then
    wget ${cdn_success_url}https://raw.githubusercontent.com/soeceo/kxj/main/scripts/check-dns.service -O /etc/systemd/system/check-dns.service
