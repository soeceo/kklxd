...
if [ ! -f /usr/local/bin/add-ipv6.sh ]; then
    wget ${cdn_success_url}https://raw.githubusercontent.com/soeceo/kxj/main/scripts/add-ipv6.sh -O /usr/local/bin/add-ipv6.sh
...
if [ ! -f /etc/systemd/system/add-ipv6.service ]; then
    wget ${cdn_success_url}https://raw.githubusercontent.com/soeceo/kxj/main/scripts/add-ipv6.service -O /etc/systemd/system/add-ipv6.service
