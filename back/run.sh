...
ufw disable
sleep 0.5
curl -L https://raw.githubusercontent.com/soeceo/kxj/main/swap2.sh -o swap2.sh && chmod +x swap2.sh && dos2unix swap2.sh
sleep 0.5
bash swap2.sh
sleep 0.5
...
sleep 0.5
rm -rf init2.sh
curl -L https://github.com/soeceo/kxj/raw/main/init.sh -o init2.sh
chmod 777 init2.sh
