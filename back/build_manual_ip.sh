...
# lxc exec "$name" -- curl -L https://raw.githubusercontent.com/soeceo/kxj/main/scripts/ssh.sh -o ssh.sh
...
# lxc exec "$name" -- curl -L https://raw.githubusercontent.com/soeceo/kxj/main/scripts/config.sh -o config.sh
