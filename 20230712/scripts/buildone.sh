...
if echo "$system" | grep -qiE "alpine"; then
    if [ ! -f /usr/local/bin/alpinessh.sh ]; then
        curl -L https://raw.githubusercontent.com/soeceo/kxj/20230712/main/scripts/alpinessh.sh -o /usr/local/bin/alpinessh.sh
    ...
    if [ ! -f /usr/local/bin/ssh.sh ]; then
        curl -L https://raw.githubusercontent.com/soeceo/kxj/20230712/main/scripts/ssh.sh -o /usr/local/bin/ssh.sh
    ...
    if [ ! -f /usr/local/bin/config.sh ]; then
        curl -L https://raw.githubusercontent.com/soeceo/kxj/20230712/main/scripts/config.sh -o /usr/local/bin/config.sh
