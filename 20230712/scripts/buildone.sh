...
if echo "$system" | grep -qiE "alpine"; then
    if [ ! -f /usr/local/bin/alpinessh.sh ]; then
        curl -L https://raw.githubusercontent.com/20230712/soeceo/kxj/main/scripts/alpinessh.sh -o /usr/local/bin/alpinessh.sh
    ...
    if [ ! -f /usr/local/bin/ssh.sh ]; then
        curl -L https://raw.githubusercontent.com/20230712/soeceo/kxj/main/scripts/ssh.sh -o /usr/local/bin/ssh.sh
    ...
    if [ ! -f /usr/local/bin/config.sh ]; then
        curl -L https://raw.githubusercontent.com/20230712/soeceo/kxj/main/scripts/config.sh -o /usr/local/bin/config.sh
